...
from ScanDL2.scandl_module.scripts.sp_load_celer_zuco import load_celer, load_celer_speakers, process_celer
from ScanDL2.scandl_module.scripts.sp_load_celer_zuco import load_zuco, process_zuco, get_kfold, get_kfold_indices_combined
